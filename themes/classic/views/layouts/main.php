...
<head>
	...
	<link rel="stylesheet" href="<?php echo Yii::app()->theme->baseUrl?>/css/maicons.css">

	<link rel="stylesheet" href="<?php echo Yii::app()->theme->baseUrl?>/vendor/animate/animate.css">

	<link rel="stylesheet" href="<?php echo Yii::app()->theme->baseUrl?>/vendor/owl-carousel/css/owl.carousel.css">

	<link rel="stylesheet" href="<?php echo Yii::app()->theme->baseUrl?>/vendor/fancybox/css/jquery.fancybox.css">
			...
			<div class="slider-wrapper">
				<div class="owl-carousel hero-carousel">
					<div class="hero-carousel-item">
						<img src="<?php echo Yii::app()->theme->baseUrl?>/img/bg_image_1.jpg" alt="">
					...
					<div class="hero-carousel-item">
						<img src="<?php echo Yii::app()->theme->baseUrl?>/img/bg_image_2.jpg" alt="">
						<div class="img-caption">
					...
					<div class="hero-carousel-item">
						<img src="<?php echo Yii::app()->theme->baseUrl?>/img/bg_image_3.jpg" alt="">
						<div class="img-caption">
		...
		<div class="page-section">
			<div class="container">
				<div class="row align-items-center">
					...
					<div class="col-lg-6 py-3">
						<div class="about-img">
							<img src="<?php echo Yii::app()->theme->baseUrl?>/img/about.jpg" alt="">
						</div>
					</div>
				</div>
			</div>
...
<!--  
			...
			<div class="container">
				...
				<div class="row justify-content-center">
					<div class="col-md-6 col-lg-4 col-xl-3 py-3 mb-3">
						<div class="text-center">
							<div class="img-fluid mb-4">
								<img src="<?php echo Yii::app()->theme->baseUrl?>/img/icons/web_development.svg" alt="">
							</div>
					...
					<div class="col-md-6 col-lg-4 col-xl-3 py-3 mb-3">
						<div class="text-center">
							<div class="img-fluid mb-4">
								<img src="<?php echo Yii::app()->theme->baseUrl?>/img/icons/graphics_design.svg" alt="">
							</div>
					...
					<div class="col-md-6 col-lg-4 col-xl-3 py-3 mb-3">
						<div class="text-center">
							<div class="img-fluid mb-4">
								<img src="<?php echo Yii::app()->theme->baseUrl?>/img/icons/seo_and_marketing.svg" alt="">
							</div>
							<h5>SEO & Marketing</h5>
						</div>
					</div>
					...
					<div class="col-md-6 col-lg-4 col-xl-3 py-3 mb-3">
						<div class="text-center">
							<div class="img-fluid mb-4">
								<img src="<?php echo Yii::app()->theme->baseUrl?>/img/icons/customer_services.svg" alt="">
							</div>
					...
					<div class="col-md-6 col-lg-4 col-xl-3 py-3 mb-3">
						<div class="text-center">
							<div class="img-fluid mb-4">
								<img src="<?php echo Yii::app()->theme->baseUrl?>/img/icons/app_development.svg" alt="">
							</div>
					...
					<div class="col-md-6 col-lg-4 col-xl-3 py-3 mb-3">
						<div class="text-center">
							<div class="img-fluid mb-4">
								<img src="<?php echo Yii::app()->theme->baseUrl?>/img/icons/ui_ux_design.svg" alt="">
							</div>
							<h5>UI/UX Design</h5>
						</div>
					</div>
					...
					<div class="col-md-6 col-lg-4 col-xl-3 py-3 mb-3">
						<div class="text-center">
							<div class="img-fluid mb-4">
								<img src="<?php echo Yii::app()->theme->baseUrl?>/img/icons/product_design.svg" alt="">
							</div>
					...
					<div class="col-md-6 col-lg-4 col-xl-3 py-3 mb-3">
						<div class="text-center">
							<div class="img-fluid mb-4">
								<img src="<?php echo Yii::app()->theme->baseUrl?>/img/icons/data_analyst.svg" alt="">
							</div>
							<h5>Data Analyst</h5>
						</div>
					</div>
				...
				<div class="owl-carousel team-carousel mt-5">
					<div class="team-wrap">
						<div class="team-profile">
							<img src="<?php echo Yii::app()->theme->baseUrl?>/img/teams/team_1.jpg" alt="">
						</div>
					...
					<div class="team-wrap">
						<div class="team-profile">
							<img src="<?php echo Yii::app()->theme->baseUrl?>/img/teams/team_2.jpg" alt="">
						</div>
						<div class="team-content">
					...
					<div class="team-wrap">
						<div class="team-profile">
							<img src="<?php echo Yii::app()->theme->baseUrl?>/img/teams/team_3.jpg" alt="">
						</div>
						<div class="team-content">
							<h5>Anna Anderson</h5>
			...
			<div class="container">
				...
				<div class="row mt-3">
					<div class="col-lg-4 py-3">
						<div class="portfolio">
							<a href="<?php echo Yii::app()->theme->baseUrl?>/img/portfolio/work-1.jpg" data-fancybox="portfolio">
								<img src="<?php echo Yii::app()->theme->baseUrl?>/img/portfolio/work-1.jpg" alt="">
							</a>
						</div>
					</div>
					<div class="col-lg-4 py-3">
						<div class="portfolio">
							<a href="<?php echo Yii::app()->theme->baseUrl?>/img/portfolio/work-2.jpg" data-fancybox="portfolio">
								<img src="<?php echo Yii::app()->theme->baseUrl?>/img/portfolio/work-2.jpg" alt="">
							</a>
						</div>
					</div>
					<div class="col-lg-4 py-3">
						<div class="portfolio">
							<a href="<?php echo Yii::app()->theme->baseUrl?>/img/portfolio/work-3.jpg" data-fancybox="portfolio">
								<img src="<?php echo Yii::app()->theme->baseUrl?>/img/portfolio/work-3.jpg" alt="">
							</a>
						</div>
					</div>
					<div class="col-lg-4 py-3">
						<div class="portfolio">
							<a href="<?php echo Yii::app()->theme->baseUrl?>/img/portfolio/work-4.jpg" data-fancybox="portfolio">
								<img src="<?php echo Yii::app()->theme->baseUrl?>/img/portfolio/work-4.jpg" alt="">
							</a>
						</div>
					</div>
					<div class="col-lg-4 py-3">
						<div class="portfolio">
							<a href="<?php echo Yii::app()->theme->baseUrl?>/img/portfolio/work-5.jpg" data-fancybox="portfolio">
								<img src="<?php echo Yii::app()->theme->baseUrl?>/img/portfolio/work-5.jpg" alt="">
							</a>
						</div>
					</div>
					<div class="col-lg-4 py-3">
						<div class="portfolio">
							<a href="<?php echo Yii::app()->theme->baseUrl?>/img/portfolio/work-6.jpg" data-fancybox="portfolio">
								<img src="<?php echo Yii::app()->theme->baseUrl?>/img/portfolio/work-6.jpg" alt="">
							</a>
						</div>
					</div>
				</div>
			...
			<div class="container">
				<div class="owl-carousel testimonial-carousel">
					<div class="card-testimonial">
						...
						<div class="author">
							<div class="avatar">
								<img src="<?php echo Yii::app()->theme->baseUrl?>/img/person/person_1.jpg" alt="">
							</div>
							<div class="d-inline-block ml-2">
					...
					<div class="card-testimonial">
						...
						<div class="author">
							<div class="avatar">
								<img src="<?php echo Yii::app()->theme->baseUrl?>/img/person/person_2.jpg" alt="">
							</div>
							<div class="d-inline-block ml-2">
					...
					<div class="card-testimonial">
						...
						<div class="author">
							<div class="avatar">
								<img src="<?php echo Yii::app()->theme->baseUrl?>/img/person/person_3.jpg" alt="">
							</div>
							<div class="d-inline-block ml-2">
		...
		<div class="page-section">
			<div class="container-fluid">
				<div class="row row-cols-md-3 row-cols-lg-5 justify-content-center text-center">
					<div class="py-3 px-5">
						<img src="<?php echo Yii::app()->theme->baseUrl?>/img/clients/airbnb.png" alt="">
					</div>
					<div class="py-3 px-5">
						<img src="<?php echo Yii::app()->theme->baseUrl?>/img/clients/google.png" alt="">
					</div>
					<div class="py-3 px-5">
						<img src="<?php echo Yii::app()->theme->baseUrl?>/img/clients/mailchimp.png" alt="">
					</div>
					<div class="py-3 px-5">
						<img src="<?php echo Yii::app()->theme->baseUrl?>/img/clients/paypal.png" alt="">
					</div>
					<div class="py-3 px-5">
						<img src="<?php echo Yii::app()->theme->baseUrl?>/img/clients/stripe.png" alt="">
					</div>
				</div>
			</div> 
		</div> 
	...
	<script src="<?php echo Yii::app()->theme->baseUrl?>/js/jquery-3.5.1.min.js"></script>

	<script src="<?php echo Yii::app()->theme->baseUrl?>/js/bootstrap.bundle.min.js"></script>

	<script src="<?php echo Yii::app()->theme->baseUrl?>/vendor/owl-carousel/js/owl.carousel.min.js"></script>

	<script src="<?php echo Yii::app()->theme->baseUrl?>/vendor/wow/wow.min.js"></script>

	<script src="<?php echo Yii::app()->theme->baseUrl?>/vendor/fancybox/js/jquery.fancybox.min.js"></script>

	<script src="<?php echo Yii::app()->theme->baseUrl?>/vendor/isotope/isotope.pkgd.min.js"></script>

	<script src="<?php echo Yii::app()->theme->baseUrl?>/js/google-maps.js"></script>
